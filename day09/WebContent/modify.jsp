            ...
            <div class="p-5">
              ...
              <form action="modify" method="post">
                                             <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Email</label>
	                                            <input readonly value="<%= session.getAttribute("user_id") %>"name="memberid" class="form-control py-4" 
                                            ...
                                            <div class="form-group mt-4 mb-0"><input type="submit" class="btn btn-primary btn-block" value="정보 수정"></div>
                                        </form>
              <hr>
